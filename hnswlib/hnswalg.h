...
class HierarchicalNSW : public AlgorithmInterface<dist_t> {
 public:
    ...
    HierarchicalNSW(
        ...
        dist_func_param_ = s->get_dist_func_param();//输入数据的维度，point(x,y)是二维
        M_ = M;
        maxM_ = M_;
        maxM0_ = M_ * 2;
    ...
    tableint addPoint(const void *data_point, labeltype label, int level) {
        tableint cur_c = 0;
        {
            ...
            if (search != label_lookup_.end()) {
                ...
                cout<<"find: "<<(int)search->second<<endl;
                if (allow_replace_deleted_) {
        ...
        if ((signed)currObj != -1) {
            if (curlevel < maxlevelcopy) {
                ...
                cout<<"curdist: "<<curdist<<endl;getchar();
